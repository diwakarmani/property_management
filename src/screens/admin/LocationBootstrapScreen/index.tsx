...
const styles = StyleSheet.create({
  ...
  importTitle: { fontSize: typography.fontSize.md, fontWeight: '600', color: colors.text },
  ...
  importBtnText: { color: colors.white, fontWeight: '700', fontSize: typography.fontSize.sm },
  ...
  cardInfo: { flex: 1 },
  cardName: { fontSize: typography.fontSize.md, fontWeight: '600', color: colors.text },
  ...
  actionBtnText: { fontSize: typography.fontSize.sm, color: colors.primary, fontWeight: '600' },
  ...
  backBtnText: { color: colors.primary, fontWeight: '600', fontSize: typography.fontSize.sm },
  importAllBtn: {
    backgroundColor: colors.primary,
    paddingHorizontal: spacing.md,
    paddingVertical: spacing.xs,
  ...
  importAllBtnText: { color: colors.white, fontWeight: '600', fontSize: typography.fontSize.sm },

  activeTag: { backgroundColor: '#27AE6020', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 10 },
  activeTagText: { fontSize: 11, color: '#27AE60', fontWeight: '600' },
  activateBtn: {
    backgroundColor: colors.primary,
  ...
  activateBtnText: { color: colors.white, fontSize: 12, fontWeight: '600' },
});
