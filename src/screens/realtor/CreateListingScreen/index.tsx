  ...
  const handleSubmit = () => {
    ...
    PropertyService.createProperty(payload)
      .then(res => {
        Alert.alert(
          'Listing Created',
          `"${res.data.data.title}" has been saved as Draft. You can publish it from My Listings.`,
  ...
  const renderStep1 = () => (
    <ScrollView style={styles.form} keyboardShouldPersistTaps="handled">
      ...
      <TextInput
        ...
        placeholder={form.listingType === 'SALE' ? 'e.g. 5000000' : 'Monthly rent e.g. 25000'}
  ...
  const renderStep3 = () => (
    <ScrollView style={styles.form} keyboardShouldPersistTaps="handled">
      ...
      <View style={styles.summaryCard}>
        ...
        <Text style={styles.summaryLine}>{form.addressLine1}, {form.city}, {form.state}</Text>
      </View>
    </ScrollView>
  );
